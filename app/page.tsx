...
export default function Home() {
  ...
  return <main className="shell">
    <header><div><span className="eyebrow">RENEWMARGIN</span><h1>Know which service agreements are quietly losing money.</h1><p>Turn actual labor and material costs into profitable renewal prices—before the next renewal.</p></div><button>Import agreements</button></header>
    ...
    <section className="callout"><div><span className="eyebrow">FREE MARGIN LEAK SCAN</span><h2>Upload your agreement export. See the dollars before you buy anything.</h2></div><button>Run a free scan</button></section>
  </main>;
}
